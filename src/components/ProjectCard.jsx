...
const ProjectCard = ({ project, index }) => (
  <motion.article
    className="futuristic-card group rounded-[24px] sm:rounded-[28px]"
  ...
  >
    ...
    <div className="relative p-5 sm:p-6">
      ...
      <h3 className="mt-3 text-xl font-extrabold text-white sm:text-2xl">{project.title}</h3>
      <p className="muted mt-3 text-sm leading-7 sm:text-base">{project.description}</p>
