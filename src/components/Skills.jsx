    ...
    <div className="page-shell">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {skillGroups.map((group, index) => (
          <motion.article
            key={group.title}
            className="futuristic-card rounded-[28px] p-6"
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {group.skills.map((skill) => {
                ...
                return (
                  <span key={skill} className="inline-flex items-center gap-2 rounded-full border border-[rgba(77,184,255,0.18)] bg-white/[0.035] px-3 py-2 text-sm font-bold text-white">
